...
function Task() {
  ...
  return (
    <Card sx={{ width: '100%', maxWidth: 500, height: 252 }}>
      ...
      <CardActions>
        <Typography variant="h6" style={{display: 'inline-block'}}>질문 제목입니다. 내용이 길어...</Typography><br/>
        ...
        {/* <Button size="small">질문 제목입니다. 내용이 길어...</Button> */}
      </CardActions>
    </Card>
  );
